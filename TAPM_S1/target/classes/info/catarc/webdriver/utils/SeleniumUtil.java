package info.catarc.webdriver.utils;
...
public class SeleniumUtil {
	...
	public void inFrame(String frameId) {
		try{
			...
			System.out.println("Enter into frame " + frameId);
		}
		catch(Exception e){
			System.out.println("Can't enter into frame " + frameId);
		}
	}
	...
	public void inFrame(int frameNum) {
		try{
			...
			System.out.println("Enter into frame " + frameNum);
		}
		catch(Exception e){
			System.out.println("Can't enter into frame " + frameNum);
		}
	}
	...
	public void outFrame(){
		try{
			...
			System.out.println("Return to default content passed");
		}
		catch(Exception e){
			System.out.println("Return to default content failed");
		}
	}
	...
	public void switchToNewPage(String url){
		try{
	...
	public void switchToNewWindow(){
		if(driver.getWindowHandles().size() == 2){
			...
			System.out.print("Switch to a new Window " + driver.getWindowHandles().iterator().next().toString());
		}
		else{
			System.out.print("No new Window to switch to");
		}
	}
...
//	public void submit(By lpButtonLogin) {
//		// TODO Auto-generated method stub
//      	driver.findElement(lpButtonLogin).submit();
//      	logger.info("点击元素 [" + lpButtonLogin + "]");
//	}
